...
module Maintainer
  class UpdateUsersActiveState
    def self.update_users_active_state
      if ARGV.size < 2
        puts 'Usage: rails runner lib/maintainer/update_users_active_state.rb <activate|deactivate> <name1> <name2> ...'
